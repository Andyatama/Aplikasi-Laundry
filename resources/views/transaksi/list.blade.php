...
<a href="{{ route('transaksi.create') }}" class="btn btn-primary mb-3" style="background-color: white; color: black;">Tambah Transaksi</a>
            ...
            <td>
                <div class="d-flex">
                    <a href="{{ route('transaksi.edit', $trx->id) }}" class="btn mr-2 rounded-circle py-2"
                        style="background-color: #30D5C8"><i class="fas fa-fw fa-pen text-white"></i></a>
